...
public class LoginbuttonTest {
  ...
  public void loginbutton() throws InterruptedException {
    ...
    driver.manage().window().setSize(new Dimension(1027, 728));
    Thread.sleep(3000);
    driver.findElement(By.className("button-default button-default--transparent-primary navbar-form-recovery__submit js-login-member-button")).click();
    Thread.sleep(3000);
    ...
    driver.findElement(By.id("login-form__password")).sendKeys("WSL2020qa");
    driver.findElement(By.cssSelector(".js-login-form-submit")).click();
  }
}
