	...
	private void assurant(WebDriver driver) throws InterruptedException	{
		...
		try {
			...
			Thread.sleep(8000);
			 ...
			 driver.findElement(By.id("claimNumber")).sendKeys("snstub__PPNN-144");
			 Thread.sleep(4000);
			 ...
			 Thread.sleep(5000);
			 driver.findElement(By.xpath("//*[@id=\"ticket-item-form\"]/fieldset/div[2]/div[2]/div/div/div/div[2]")).click();
			 Thread.sleep(5000);
