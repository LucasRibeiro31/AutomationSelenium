...
import java.net.URL;
public class In_Store_StartNewTest {
  ...
  public void startNew() throws InterruptedException {
    ...
    Thread.sleep(15000);
    driver.findElement(By.cssSelector("#claim [href^='/ticket/edit/']")).click();  // A opção Href^ serve para poder encontrar o inicio da frase. ex /ticket.......
    Thread.sleep(5000);
